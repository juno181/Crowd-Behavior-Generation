...
class CrowdESEmitterPreConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`CrowdESEmitterPreConfig`]. It is based on the
    ...
    ```python
    >>> from transformers import CrowdESEmitterPreModel, CrowdESEmitterPreConfig

    >>> # Initializing a SegFormer nvidia/segformer-b0-finetuned-ade-512-512 style configuration
    >>> configuration = CrowdESEmitterPreConfig()

    >>> # Initializing a model from the nvidia/segformer-b0-finetuned-ade-512-512 style configuration
    >>> model = CrowdESEmitterPreModel(configuration)

    >>> # Accessing the model configuration
    >>> configuration = model.config
    ```"""

    model_type = 'crowdes_emitter_pre'
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.num_unit_labels = num_unit_labels
